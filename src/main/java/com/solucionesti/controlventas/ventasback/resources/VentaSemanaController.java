...
public class VentaSemanaController {

    private final String entidad = "/ventas_semana";

    @Autowired
    private IVentaSemanaService objService;
    Map<String, Object> response = new HashMap<>();

    @GetMapping(entidad)
    public ResponseEntity<?> index() {
        List<VentaSemana> objNew = null;
    ...
    public ResponseEntity<?> show(@PathVariable Long id) {
        ...
        return new ResponseEntity<VentaSemana>(obj, HttpStatus.OK);
    }

    @PostMapping(entidad)
    public ResponseEntity<?> create(@Valid @RequestBody VentaSemana x, BindingResult result) {

        VentaSemana objNew = null;
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> update(@Valid @RequestBody VentaSemana fl, BindingResult result, @PathVariable Long id) {

        VentaSemana flActual = objService.getId(id);
        VentaSemana flActualizado = null;
        Map<String, Object> response = new HashMap<>();
        ...
        try {
            ...
            flActual.setFechaInicio(fl.getFechaInicio());
